...
CMDControllerCommandHandler acquire_test_default_ser = [](ConstCommandShrdPtrVec received_command) {
  ...
  ASSERT_EQ(reinterpret_cast<const MonitorCommand*>(received_command[0].get())->destination_topic.compare("topic-dest"), 0);
};
boost::json::value acquire_default_ser = {
    {KEY_COMMAND, "monitor"}, {KEY_ACTIVATE, true}, {KEY_PROTOCOL, "pva"}, {KEY_PV_NAME, "channel::a"}, {KEY_DEST_TOPIC, "topic-dest"}};
...
boost::json::value get_json = {
    {KEY_COMMAND, "get"}, {KEY_PROTOCOL, "pva"}, {KEY_PV_NAME, "channel::a"}, {KEY_SERIALIZATION, "json"}, {KEY_DEST_TOPIC, "topic-dest"}};
...
boost::json::value get_msgpack = {
    {KEY_COMMAND, "get"}, {KEY_PROTOCOL, "pva"}, {KEY_PV_NAME, "channel::a"}, {KEY_SERIALIZATION, "msgpack"}, {KEY_DEST_TOPIC, "topic-dest"}};
...
boost::json::value get_msgpack_compact = {
    {KEY_COMMAND, "get"}, {KEY_PROTOCOL, "pva"}, {KEY_PV_NAME, "channel::a"}, {KEY_SERIALIZATION, "msgpack-compact"}, {KEY_DEST_TOPIC, "topic-dest"}};
...
boost::json::value info_json = {{KEY_COMMAND, "info"}, {KEY_PROTOCOL, "pva"}, {KEY_PV_NAME, "channel::a"}, {KEY_DEST_TOPIC, "topic-dest"}};
