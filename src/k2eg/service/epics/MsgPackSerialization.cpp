...
// void MsgPackSerializer::processScalarArray(const pvd::PVScalarArray* scalarArray, msgpack::packer<msgpack::sbuffer>&
// packer)
// {
...
// void MsgPackSerializer::processStructure(const epics::pvData::PVStructure* structure,
...
// void MsgPackSerializer::processStructureArray(pvd::PVStructureArray::const_svector structure_array,
// msgpack::packer<msgpack::sbuffer>& packer)
// {
...
// void MsgPackSerializer::processUnionArray(const pvd::PVUnionArray::const_svector union_array,
// msgpack::packer<msgpack::sbuffer>& packer)
// {
